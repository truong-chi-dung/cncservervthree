(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardDashboardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div *ngIf=\"loginService.isUserLoggedIn()\" class=\"container\">\r\n    <app-update-device></app-update-device>\r\n</div>\r\n<div class=\"container-fluid\">\r\n    <app-devices-card></app-devices-card>\r\n</div>\r\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardDevicesCardDevicesCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDashboardUpdateDeviceUpdateDeviceComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDetailEditDetailEditDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDetailPartCountMonitorPartCountMonitorComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppServiceAuthGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto = AuthGuardService.prototype;

      _proto.canActivateChild = function canActivateChild(childRoute, state) {
  ...
  function srcAppServiceAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto2 = AuthenticationService.prototype;

      _proto2.authenticate = function authenticate(username, password) {
      ...
      _proto2.isUserLoggedIn = function isUserLoggedIn() {
        var user = sessionStorage.getItem('username'); // console.log(!(user === null));
  ...
  /***/
  function srcAppServiceDeviceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function DeviceService(http) {
        this.http = http; // getDevicesUrl = 'http://localhost:8080/api/devices/';

        this.getDevicesUrl = '/api/devices/';
      }

      var _proto3 = DeviceService.prototype;

      _proto3.getDevices = function getDevices(ipPort) {
        // return this.http.get<Device[]>(this.getDevicesUrl);
        return this.http.get(ipPort + this.getDevicesUrl);
      };

      _proto3.getDevice = function getDevice(ipPort, id) {
      ...
      _proto3.deleteDevice = function deleteDevice(ipPort) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return _context.abrupt("return", this.http.get(ipPort + this.getDevicesUrl + 'delete').toPromise());
      ...
      _proto3.updateDevice = function updateDevice(ipPort, id, deviceInfo) {
        var url = ipPort + "/api/devices/update/" + id;
        console.log(deviceInfo);
        return this.http.put(url, deviceInfo);
      };

      _proto3.createDevices = function createDevices(ipPort) {
        console.log(ipPort + this.getDevicesUrl + 'create');
        return this.http.get(ipPort + this.getDevicesUrl + 'create');
      };

      _proto3.exportCsv = function exportCsv(ipPort) {
  ...
  /***/
  function srcAppServicePartcountServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PartcountService", function () {
      return PartcountService;
    });
    /* harmony import */
    ...
    var PartcountService =
    /*#__PURE__*/
    function () {
      function PartcountService(http) {
        this.http = http; // getPartCountUrl = 'http://localhost:8080/streams/partcount/period/';
      ...
      var _proto4 = PartcountService.prototype;

      _proto4.getPartCountByDeviceId = function getPartCountByDeviceId(ipPort, id) {
        return this.http.get(ipPort + this.getPartCountUrl + id);
      };

      _proto4.getPartCountByDeviceIdAndPeriod = function getPartCountByDeviceIdAndPeriod(ipPort, id, shift, startTime, endTime) {
    ...
    PartcountService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    PartcountService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], PartcountService);
    /***/
  },
  ...
  /***/
  function srcAppServiceRefreshServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var RefreshService = RefreshService_1 =
    /*#__PURE__*/
    function () {
      function RefreshService() {}

      var _proto5 = RefreshService.prototype;

      _proto5.setInterval = function setInterval(newInterval) {
        RefreshService_1.interval$.next(newInterval);
      };

      _proto5.withRefresh = function withRefresh() {
        return RefreshService_1.interval$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (int) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(int, int);
        }));
      };
    ...
    RefreshService = RefreshService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], RefreshService);
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _detail_edit_detail_edit_detail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./detail/edit-detail/edit-detail.component */
    ...
    var _service_auth_guard_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var routes = [{
      ...
      children: [{
        path: 'edit',
        component: _detail_edit_detail_edit_detail_component__WEBPACK_IMPORTED_MODULE_6__["EditDetailComponent"]
      }]
    }, {
      path: 'detail/:id/:startTime/:endTime/:shift',
      component: _detail_detail_component__WEBPACK_IMPORTED_MODULE_4__["DetailComponent"]
    }, {
      path: '',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _detail_detail_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["RouterModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModule"], _dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_5__["DashboardModule"], _detail_detail_module__WEBPACK_IMPORTED_MODULE_9__["DetailModule"]],
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_11__["LoginComponent"], _logout_logout_component__WEBPACK_IMPORTED_MODULE_12__["LogoutComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_13__["HeaderComponent"]],
      providers: [],
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto6 = DashboardComponent.prototype;
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _devices_card_devices_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./devices-card/devices-card.component */
    ...
    var _update_device_update_device_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./update-device/update-device.component */
    ...
    DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], _devices_card_devices_card_component__WEBPACK_IMPORTED_MODULE_4__["DevicesCardComponent"], _update_device_update_device_component__WEBPACK_IMPORTED_MODULE_6__["UpdateDeviceComponent"]],
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]]
    })], DashboardModule);
    /***/
  },
  ...
  /***/
  function srcAppDashboardDevicesCardDevicesCardComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDashboardDevicesCardDevicesCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DevicesCardComponent", function () {
      return DevicesCardComponent;
    });
    /* harmony import */
    ...
    var src_app_service_device_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/@service/device.service */
    "./src/app/@service/device.service.ts");
    /* harmony import */


    var src_app_service_refresh_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/@service/refresh.service */
    "./src/app/@service/refresh.service.ts");
    /* harmony import */
    ...
    var DevicesCardComponent =
    /*#__PURE__*/
    function () {
      // private ip = 'http://localhost:8080';
      function DevicesCardComponent(deviceService, refreshService) {
        this.deviceService = deviceService;
        this.refreshService = refreshService;
        this.alive = true;
        this.speedVal = 5000;
        this.mockCurPart = 50; // .origin this will give you the ip:port, .hostname for ip
      ...
      var _proto7 = DevicesCardComponent.prototype;

      _proto7.ngOnInit = function ngOnInit() {
        var _this = this;

        this.deviceService.getDevices(this.ip).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(function () {
          return _this.alive;
        })).subscribe(function (devices) {
          return _this.devices = devices;
        });
        this.updateDeviceStatus();
        setInterval(function () {
          _this.curHour = new Date();
          _this.timeIndex = _this.getTimeIndex(_this.curHour.getHours());
        }, 3600 * 1000);
      };

      _proto7.updateDeviceStatus = function updateDeviceStatus() {
        var _this2 = this;

        this.timeRefreshSubscription = this.refreshService.withRefresh().subscribe(function () {
          _this2.deviceService.getDevices(_this2.ip).subscribe(function (data) {
            console.log(_this2.speedVal);
            _this2.devices = data;
          });
        });
      };

      _proto7.ngOnDestroy = function ngOnDestroy() {
        this.alive = false;
        this.timeRefreshSubscription.unsubscribe();
      };

      _proto7.getTimeIndex = function getTimeIndex(twentyFourHour) {
    ...
    DevicesCardComponent.ctorParameters = function () {
      return [{
    ...
    DevicesCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-devices-card',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./devices-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/devices-card/devices-card.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./devices-card.component.css */
      "./src/app/dashboard/devices-card/devices-card.component.css")).default]
  ...
  /***/
  function srcAppDashboardUpdateDeviceUpdateDeviceComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDashboardUpdateDeviceUpdateDeviceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UpdateDeviceComponent", function () {
    ...
    var UpdateDeviceComponent =
    /*#__PURE__*/
    function () {
      function UpdateDeviceComponent(deviceService) {
        this.deviceService = deviceService; // .origin this will give you the ip:port, .hostname for ip
        // private ip = window.location.hostname;

        this.ip = window.location.origin;
      }

      var _proto8 = UpdateDeviceComponent.prototype;

      _proto8.ngOnInit = function ngOnInit() {} // createDevices() {
      ...
      _proto8.updateDevices = function updateDevices() {
        var _this3 = this;

        console.log(this.ip);
        this.deviceService.deleteDevice(this.ip).then(function () {
          return _this3.deviceService.createDevices(_this3.ip).subscribe();
        });
      };

      _proto8.exportCsv = function exportCsv() {
    ...
    UpdateDeviceComponent.ctorParameters = function () {
      return [{
        type: src_app_service_device_service__WEBPACK_IMPORTED_MODULE_2__["DeviceService"]
      }];
    };

    UpdateDeviceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-update-device',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./update-device.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/update-device/update-device.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./update-device.component.css */
      "./src/app/dashboard/update-device/update-device.component.css")).default]
  ...
  function srcAppDetailDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function DetailComponent(loginService) {
        this.loginService = loginService;
      }

      var _proto9 = DetailComponent.prototype;
  ...
  function srcAppDetailDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _part_count_monitor_part_count_monitor_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./part-count-monitor/part-count-monitor.component */
    ...
    var _edit_detail_edit_detail_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./edit-detail/edit-detail.component */
    "./src/app/detail/edit-detail/edit-detail.component.ts");
    ...
    DetailModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_detail_component__WEBPACK_IMPORTED_MODULE_3__["DetailComponent"], _part_count_monitor_part_count_monitor_component__WEBPACK_IMPORTED_MODULE_4__["PartCountMonitorComponent"], _edit_detail_edit_detail_component__WEBPACK_IMPORTED_MODULE_9__["EditDetailComponent"]],
      imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModule"], ng2_smart_table__WEBPACK_IMPORTED_MODULE_6__["Ng2SmartTableModule"]]
    })], DetailModule);
    /***/
  },
  ...
  /***/
  function srcAppDetailEditDetailEditDetailComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDetailEditDetailEditDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditDetailComponent", function () {
    ...
    var EditDetailComponent =
    /*#__PURE__*/
    function () {
      function EditDetailComponent(route, deviceService, router) {
        this.route = route;
        this.deviceService = deviceService;
        this.router = router; // .origin this will give you the ip:port, hostname for ip
        // private ip = window.location.hostname;

        this.ip = window.location.origin;
      }

      var _proto10 = EditDetailComponent.prototype;

      _proto10.ngOnInit = function ngOnInit() {
        var _this4 = this;

        this.deviceService.getDevice(this.ip, this.route.snapshot.parent.params.id).subscribe(function (device) {
          return _this4.device = device;
        });
      };
      ...
      _proto10.onSubmit = function onSubmit() {
        ...
        console.log("PUT");
        this.deviceService.updateDevice(this.ip, this.route.snapshot.parent.params.id, this.device).toPromise().then(function () {
    ...
    EditDetailComponent.ctorParameters = function () {
      return [{
    ...
    EditDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-edit-detail',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./edit-detail.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/detail/edit-detail/edit-detail.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-detail.component.css */
      "./src/app/detail/edit-detail/edit-detail.component.css")).default]
    })], EditDetailComponent);
    /***/
  },
  ...
  /***/
  function srcAppDetailPartCountMonitorPartCountMonitorComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDetailPartCountMonitorPartCountMonitorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PartCountMonitorComponent", function () {
      return PartCountMonitorComponent;
    });
    /* harmony import */
    ...
    var src_app_service_partcount_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/@service/partcount.service */
    "./src/app/@service/partcount.service.ts");

    var PartCountMonitorComponent =
    /*#__PURE__*/
    function () {
      function PartCountMonitorComponent(route, partcountService) {
        this.route = route;
        ...
        this.ip = window.location.origin; // private ip = 'http://localhost:8080';
      ...
      var _proto11 = PartCountMonitorComponent.prototype;

      _proto11.ngOnInit = function ngOnInit() {
        var _this6 = this;

        if (this.route.snapshot.params.startTime != null && this.route.snapshot.params.endTime != null) {
          this.partcountService.getPartCountByDeviceIdAndPeriod(this.ip, this.route.snapshot.params.id, this.route.snapshot.params.shift, this.route.snapshot.params.startTime, this.route.snapshot.params.endTime).subscribe(function (partCountByDeviceId) {
            _this6.data = partCountByDeviceId;

            _this6.data.map(function (partCountsElement) {
          ...
          this.partcountService.getPartCountByDeviceId(this.ip, this.route.snapshot.params.id).subscribe(function (partCountByDeviceId) {
            _this6.data = partCountByDeviceId;
      ...
      _proto11.updateData = function updateData() {
        var _this7 = this;

        console.log(this.shift);

        if (this.shift == '3') {
          var startTime = this.date.year + "-" + this.date.month + "-" + this.date.day;
          var endTime = this.date.year + "-" + this.date.month + "-" + (this.date.day + 1).toString();
          this.partcountService.getPartCountByDeviceIdAndPeriod(this.ip, this.route.snapshot.params.id, this.shift, startTime, endTime).subscribe(function (partCountByDeviceId) {
            _this7.data = partCountByDeviceId;

            _this7.data.map(function (partCountsElement) {
              partCountsElement.timeStamp = new Date(parseInt(partCountsElement.id.toString().substring(0, 8), 16) * 1000).toString().substring(0, 24);
            });
          });
        } else {
          var _startTime = this.date.year + "-" + this.date.month + "-" + this.date.day;

          var _endTime = this.date.year + "-" + this.date.month + "-" + this.date.day;

          this.partcountService.getPartCountByDeviceIdAndPeriod(this.ip, this.route.snapshot.params.id, this.shift, _startTime, _endTime).subscribe(function (partCountByDeviceId) {
            _this7.data = partCountByDeviceId;
    ...
    PartCountMonitorComponent.ctorParameters = function () {
      return [{
    ...
    PartCountMonitorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-part-count-monitor',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./part-count-monitor.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/detail/part-count-monitor/part-count-monitor.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./part-count-monitor.component.css */
      "./src/app/detail/part-count-monitor/part-count-monitor.component.css")).default]
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto12 = HeaderComponent.prototype;
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto13 = LoginComponent.prototype;

      _proto13.ngOnInit = function ngOnInit() {};

      _proto13.checkLogin = function checkLogin() {
  ...
  function srcAppLogoutLogoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      var _proto14 = LogoutComponent.prototype;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Project\Angular\iot-angular-v-six\src\main.ts */
    "./src/main.ts");
    /***/
  }
